...
### 範例圖
<img src="https://user-images.githubusercontent.com/93152909/140537772-a12518b2-7327-4e1e-835e-3c90b3a2ab54.gif" width="500px">

## Grove
### Grove周邊驅動程式------------------------------------------------------------
> 如下載已包含 Arduino IDE 的 Blockyduino 可省略本步驟
...
* Grove 元件在連接時，需要注意 Pin 的位置，因為線是固定方向的插法，需要軟體配合硬體
* 7697插入擴充板時，請確認腳位
